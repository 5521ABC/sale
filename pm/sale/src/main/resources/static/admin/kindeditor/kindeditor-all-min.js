...
!function (window, undefined) {
    ...
    function _each(a, b) {
        if (_isArray(a)) for (var c = 0, d = a.length; d > c && b.call(a[c], c, a[c]) !== !1; c++) ; else for (var e in a) if (a.hasOwnProperty(e) && b.call(a[e], e, a[e]) === !1) break
    }
    ...
    function _toMap(a, b) {
        b = b === undefined ? "," : b;
        var c, d = {}, e = _isArray(a) ? a : a.split(b);
        return _each(e, function (a, b) {
            if (c = /^(\d+)\.\.(\d+)$/.exec(b)) for (var e = parseInt(c[1], 10); e <= parseInt(c[2], 10); e++) d[e.toString()] = !0; else d[b] = !0
        }), d
    }
    ...
    function _ready(a) {
        ...
        var e = !1;
        if (document.addEventListener) _bind(document, "DOMContentLoaded", b); else if (document.attachEvent) {
    ...
    function _getCssList(a) {
        for (var b, c = {}, d = /\s*([\w\-]+)\s*:([^;]*)(;|$)/g; b = d.exec(a);) {
            var e = _trim(b[1].toLowerCase()), f = _trim(_toHex(b[2]));
            c[e] = f
        }
        return c
    }
    ...
    function _getAttrList(a) {
        for (var b, c = {}, d = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g; b = d.exec(a);) {
            var e = (b[1] || b[2] || b[4] || b[6]).toLowerCase(), f = (b[2] ? b[3] : b[4] ? b[5] : b[7]) || "";
            c[e] = f
        }
        return c
    }
    ...
    function _formatHtml(a, b, c, d, e) {
        ...
        return a = a.replace(h, function (a, h, j, k, l, m, n) {
            var o = a, p = h || "", q = j || "", r = k.toLowerCase(), s = l || "", t = m ? " " + m : "", u = n || "";
            if (b && !g[r]) return "";
    ...
    function _mediaImg(a, b) {
        var c = b.width, d = b.height, e = b.type || _mediaType(b.src), f = _mediaEmbed(b), g = "";
    ...
    function _queryAll(a, b) {
        ...
        function j(a, b) {
            ...
            c = /^((?:\\.|[^.#\s\[<>])+)/.exec(a);
            var e = c ? c[1] : "*";
            if (c = /#((?:[\w\-]|\\.)+)$/.exec(a)) d = f(c[1], e, b); else if (c = /\.((?:[\w\-]|\\.)+)$/.exec(a)) d = g(c[1], e, b); else if (c = /\[((?:[\w\-]|\\.)+)\]/.exec(a)) d = i(c[1].toLowerCase(), null, e, b); else if (c = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                var j = c[1].toLowerCase(), k = c[2];
                d = "id" === j ? f(k, e, b) : "class" === j ? g(k, e, b) : "name" === j ? h(k, e, b) : i(j, k, e, b)
            } else for (var l, m = b.getElementsByTagName(e), n = 0, o = m.length; o > n; n++) l = m[n], 1 == l.nodeType && d.push(l);
            return d
        }
        ...
        for (v = 0, lenth = n.length; v < lenth; v++) if (q = n[v], ">" !== q) {
            if (v > 0) {
                for (r = [], w = 0, y = p.length; y > w; w++) for (t = p[w], s = j(q, t), x = 0, z = s.length; z > x; x++) u = s[x], A ? t === u.parentNode && r.push(u) : r.push(u);
                p = r
            } else p = j(q, b);
    ...
    function _computedCss(a, b) {
        var c = _getWin(a), d = _toCamel(b), e = "";
    ...
    function _copyAndDelete(a, b, c) {
        ...
        function f(e, n) {
            for (var o, p = e.firstChild; p;) {
                ...
                if (o = p.nextSibling, j > 0) if (1 == p.nodeType) if (k >= 0 && 0 >= l) b && n.appendChild(p.cloneNode(!0)), c && h.push(p); else {
                    var r;
        ...
        var g = a.doc, h = [], i = a.cloneRange().down(), j = -1, k = -1, l = -1, m = -1, n = a.commonAncestor(),
    ...
    function _getStartEnd(a, b) {
        ...
        d.collapse(b);
        var e = d.parentElement(), f = e.childNodes;
        if (0 === f.length) return {node: e.parentNode, offset: K(e).index()};
        var g = c, h = 0, i = -1, j = a.duplicate();
        _moveToElementText(j, e);
        for (var k = 0, l = f.length; l > k; k++) {
            var m = f[k];
            if (i = j.compareEndPoints("StartToStart", d), 0 === i) return {node: m.parentNode, offset: k};
            if (1 == m.nodeType) {
                var n, o = a.duplicate(), p = K(m), q = m;
        ...
        if (j = a.duplicate(), _moveToElementText(j, e), j.setEndPoint("StartToEnd", d), h -= j.text.replace(/\r\n|\n|\r/g, "").length, i > 0 && 3 == g.nodeType) for (var r = g.previousSibling; r && 3 == r.nodeType;) h -= r.nodeValue.length, r = r.previousSibling;
    ...
    function _toRange(a) {
        ...
        if (_IERANGE) {
            ...
            var e = _getStartEnd(a, !0), f = _getStartEnd(a, !1);
    ...
    function _drag(a) {
        ...
        f && K("iframe").each(function () {
            ...
            function f(a) {
                a.preventDefault();
                var b = K(_getDoc(a.target)), e = _round((b.data("pos-x") || 0) + a.pageX - o),
            ...
            if (0 === a.button || 1 === a.button) {
                a.stopPropagation();
                var j = d.get(), k = _removeUnit(b.css("left")), l = _removeUnit(b.css("top")), m = b.width(),
                    n = b.height(), o = a.pageX, p = a.pageY;
    ...
    function _tabs(a) {
        var b = _widget(a), c = b.remove, d = a.afterSelect, e = b.div, f = [];
    ...
    function _parseLangKey(a) {
        var b, c = "core";
        return (b = /^(\w+)\.(\w+)$/.exec(a)) && (c = b[1], a = b[2]), {ns: c, key: a}
    }
    ...
    function _getImageFromRange(a, b) {
        if (!a.collapsed) {
            a = a.cloneRange().up();
            var c = a.startContainer, d = a.startOffset;
        ...
        K(b).contextmenu(function (b) {
            ...
            if (0 !== a._contextmenus.length) {
                ...
                if (_each(d, function (a) {
                    ...
                    b.preventDefault();
                    var f = K(a.edit.iframe).pos(), g = _menu({
                        x: f.x + b.clientX,
                        y: f.y + b.clientY,
                        width: c,
                    ...
                    var h = _docElement(g.doc), i = g.div.height();
    ...
    function _bindNewlineEvent() {
        ...
        if (!(_IE && "br" !== d || _GECKO && 3 > _V && "p" !== d || _OPERA && 9 > _V)) {
            var e = _toMap("h1,h2,h3,h4,h5,h6,pre,li"), f = _toMap("p,h1,h2,h3,h4,h5,h6,pre,li,blockquote");
            K(c).keydown(function (g) {
                ...
                if (!(13 != e.which || e.shiftKey || e.ctrlKey || e.altKey) && "br" != d) {
                    if (_GECKO) {
                        var g = b.cmd.commonAncestor("p"), h = b.cmd.commonAncestor("a");
    ...
    function _undoToRedo(a, b) {
        var c, d, e = this, f = e.edit, g = f.doc.body;
        if (0 === a.length) return e;
        f.designMode ? (c = e.cmd.range, d = c.createBookmark(!0), d.html = g.innerHTML) : d = {html: g.innerHTML}, _addBookmarkToStack(b, d);
        var h = a.pop();
    ...
    if (!window.KindEditor) {
        ...
        _extend(KEvent, {
            init: function (a, b) {
                ...
                if (c.event = b, _each(_EVENT_PROPS, function (a, d) {
                    ...
                    var e = d.documentElement, f = d.body;
        ...
        K.query = _query, K.queryAll = _queryAll, _extend(KNode, {
            init: function (a) {
                ...
                for (var b = this, c = 0; c < b.length; c++) if (a.call(b[c], c, b[c]) === !1) return b;
                return b
            }, bind: function (a, b) {
                ...
                var a = this, b = a[0], c = 0, d = 0;
                if (b) if (b.getBoundingClientRect) {
                    var e = b.getBoundingClientRect(), f = _getScrollPos(a.doc);
                    c = e.left + f.x, d = e.top + f.y
                } else for (; b;) c += b.offsetLeft, d += b.offsetTop, b = b.offsetParent;
            ...
            if (a !== undefined && null !== a) {
                if ("string" == typeof a) {
                    ...
                    if ("@" === a.charAt(0) && (a = a.substr(1)), a.length !== d || /<.+>/.test(a)) {
                        var e = b ? b.ownerDocument || b : document, f = e.createElement("div"), g = [];
        ...
        _extend(KRange, {
            init: function (a) {
                ...
                var b, c, d, e = this, f = e.startContainer, g = e.startOffset, h = e.endContainer, i = e.endOffset,
                    j = 1;
                ...
                var b, c = this, d = c.doc, e = K('<span style="display:none;"></span>', d)[0];
            ...
            init: function (a) {
                ...
                a = _undef(a, !0);
                var b, c = this, d = c.sel, e = c.range.cloneRange().shrink(), f = e.startContainer, g = e.startOffset,
                    h = (e.endContainer, e.endOffset, _getDoc(f)), i = c.win, j = !1;
                ...
                } else if (j && e.collapse(!1), b = e.get(!0), d.removeAllRanges(), d.addRange(b), h !== document) {
                    var o = K(b.endContainer).pos();
                    i.scrollTo(o.x, o.y)
                }
                return i.focus(), c
            }, wrap: function (a) {
                var b, c = this, d = c.doc, e = c.range;
                ...
                e.enlarge();
                var h = e.createBookmark(), i = e.commonAncestor(), j = !1;
                ...
                var l = c.createElement("span"), m = c.createElement("span");
                ...
                var p = d.endContainer, q = d.endOffset;
                if (i > 0) {
                ...
                var c = this.range, d = c.endContainer, e = c.endOffset,
                    f = 3 == d.nodeType || 0 === e ? d : d.childNodes[e - 1], g = b(f);
                if (g) return g;
                ...
                var c = this.range, d = c.startContainer, e = c.startOffset, f = c.endContainer, g = c.endOffset,
                    h = 3 == d.nodeType || 0 === e ? d : d.childNodes[e - 1],
                    i = 3 == f.nodeType || 0 === g ? f : f.childNodes[g - 1], j = b(h), k = b(i);
                return j && k && j === k ? K(j) : null
            }, state: function (a) {
                var b = this, c = b.doc, d = !1;
                try {
                ...
                var d = this, e = d.doc, f = d.range;
                d.select();
                var g = d.commonNode({a: "*"});
                ...
                var j = f.startContainer, k = f.startOffset, l = f.endContainer, m = f.endOffset;
                ...
                var a = this, b = a.doc, c = a.range;
                if (a.select(), c.collapsed) {
                    var d = a.commonNode({a: "*"});
            ...
            init: function (a) {
                ...
                if (b.name = a.name || "", b.doc = a.doc || document, b.win = _getWin(b.doc), b.x = _addUnit(a.x), b.y = _addUnit(a.y), b.z = a.z, b.width = _addUnit(a.width), b.height = _addUnit(a.height), b.div = K('<div style="display:block;"></div>'), b.options = a, b._alignEl = a.alignEl, b.width && b.div.css("width", b.width), b.height && b.div.css("height", b.height), b.z && b.div.css({
                    ...
                    K(b.win).bind("scroll", function () {
                        var a = _getScrollPos(), d = a.x - c.x, e = a.y - c.y;
                ...
                var c = this, d = _removeUnit(a) || 0, e = _removeUnit(b) || 0, f = _getScrollPos();
                if (c._alignEl) {
                    var g = K(c._alignEl), h = g.pos(), i = _round(g[0].clientWidth / 2 - d / 2),
        ...
        (html = document.getElementsByTagName("html")) && (_direction = html[0].dir), _extend(KEdit, KWidget, {
            init: function (a) {
                ...
                var d = _undef(a.themesPath, ""), e = a.bodyClass, f = a.cssPath, g = a.cssData,
                ...
                if (a === undefined ? !c.designMode : a) {
                    if (!c.designMode) {
                        ...
                        var d = c.iframe, e = _removeUnit(c.height);
            ...
            init: function (a) {
                ...
                var c = K('<div class="ke-menu-item" unselectable="on"></div>'),
                    ...
                    e = K('<div class="ke-inline-block ke-menu-item-right"></div>'), f = _addUnit(a.height),
            ...
            init: function (a) {
                var b = this, c = K(a.button), d = a.fieldName || "file", e = a.url || "", f = c.val(),
                ...
                return b.bind("load", function () {
                    ...
                    var d, e = K.iframeDoc(b), f = e.getElementsByTagName("pre")[0], g = "";
            ...
            init: function (a) {
                var b = this, c = _undef(a.shadowMode, !0);
                a.z = a.z || 811213, a.shadowMode = !1, a.autoScroll = _undef(a.autoScroll, !0), KDialog.parent.init.call(b, a);
                var d = a.title, e = K(a.body, b.doc), f = a.previewBtn, g = a.yesBtn, h = a.noBtn, i = a.closeBtn,
                ...
                if ((f || g || h) && k.append(n), _each([{btn: f, name: "preview"}, {btn: g, name: "yes"}, {
                    btn: h,
                    name: "no"
                }], function () {
                    if (this.btn) {
                    ...
                    var o = _docElement(b.doc), p = Math.max(o.scrollWidth, o.clientWidth),
        ...
        KEditor.prototype = {
            lang: function (a) {
                ...
                var g = K(".toolbar", f), h = K(".edit", f), i = b.statusbar = K(".statusbar", f);
                ...
                }), l = _removeUnit(e) - k.div.height(), m = b.edit = _edit({
                ...
                return i.removeClass("statusbar").addClass("ke-statusbar").append('<span class="ke-inline-block ke-statusbar-center-icon"></span>').append('<span class="ke-inline-block ke-statusbar-right-icon"></span>'), b._fullscreenResizeHandler && (K(window).unbind("resize", b._fullscreenResizeHandler), b._fullscreenResizeHandler = null), a(), c ? (b._fullscreenResizeHandler = function () {
                    ...
                    moveEl: f, clickEl: i, moveFn: function (a, c, d, e, f, g) {
                        e += g, b.resize(null, e)
                    }
                ...
                a = _undef(a, !0);
                var b, c = this, d = c.edit, e = d.doc.body, f = _removeTempTag(e.innerHTML);
                ...
                if (a.z = b.options.zIndex, a.shadowMode = _undef(a.shadowMode, b.shadowMode), a.closeBtn = _undef(a.closeBtn, {
                    ...
                    var c = b.dialogs[0], d = b.dialogs[b.dialogs.length - 1];
                ...
                if (a.dialogs.length > 0 && a.dialogs.pop().remove(), a.dialogs.length > 0) {
                    var b = a.dialogs[0], c = a.dialogs[a.dialogs.length - 1];
            ...
            _each("undo,redo".split(","), function (a, d) {
            ...
            }), b.addContextmenu({title: "-"}), _each("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function (a, d) {
                c[d] && b.afterCreate(function () {
                    _ctrl(this.edit.doc, c[d], function () {
                ...
                var d, e, f, g = b.edit.doc, h = "__kindeditor_paste__", i = !1;
    ...
    var b = this, c = "anchor", d = b.lang(c + ".");
    b.plugin.anchor = {
        edit: function () {
            var e = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keName">' + d.name + "</label>", '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:100px;" />', "</div>", "</div>"].join(""),
                ...
                }), g = f.div, h = a('input[name="name"]', g), i = b.plugin.getSelectedAnchor();
    ...
    function b() {
        var a = e.edit, b = a.doc.body;
        a.iframe[0].scroll = "no", b.style.overflowY = "hidden"
    }

    function c() {
        var b = e.edit, c = b.doc.body;
    ...
    var b = this, c = "baidumap", d = b.lang(c + "."), e = a.undef(b.mapWidth, 558), f = a.undef(b.mapHeight, 360);
    b.clickToolbar(c, function () {
        function g() {
        ...
        var h, i,
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        var a = h.map, c = a.getCenter(), d = c.lng + "," + c.lat, g = a.getZoom(),
                            i = [o[0].checked ? b.pluginsPath + "baidumap/index.ftl" : "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(d), "&zoom=" + encodeURIComponent(g), "&width=" + e, "&height=" + f, "&markers=" + encodeURIComponent(d), "&markerStyles=" + encodeURIComponent("l,A")].join("");
            ...
            }), l = k.div, m = a('[name="address"]', l), n = a('[name="searchBtn"]', l),
    ...
    b.clickToolbar(c, function () {
        ...
        var f, g,
            h = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', d.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + d.search + '" />', "</span>", "</div>", '<div class="ke-map" style="width:558px;height:360px;"></div>', "</div>"].join(""),
            i = b.createDialog({
                name: c,
                width: 600,
                title: b.lang(c),
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        var a = (f.geocoder, f.map), c = a.getCenter().lat() + "," + a.getCenter().lng(),
                            d = a.getZoom(), e = a.getMapTypeId(), g = "http://maps.googleapis.com/maps/api/staticmap";
            ...
            }), j = i.div, k = a('[name="address"]', j), l = a('[name="searchBtn"]', j),
    ...
    var b = this, c = "emoticons", d = b.emoticonsPath || b.pluginsPath + "emoticons/images/",
        e = void 0 === b.allowPreviewEmoticons ? !0 : b.allowPreviewEmoticons, f = 1;
    b.clickToolbar(c, function () {
        function g(c, e, f) {
            c.mouseover(v ? function () {
                ...
                b.insertHtml('<img src="' + d + f + '.gif" border="0"  class="gif-photo" alt="" />').hideMenu().focus(), a.stop()
            })
        }
        ...
        var l = 5, m = 9, n = 135, o = 0, p = l * m, q = Math.ceil(n / p), r = Math.floor(m / 2),
            s = a('<div class="ke-plugin-emoticons"></div>'), t = [], u = b.createMenu({
                name: c, beforeRemove: function () {
                    i()
                }
            });
        u.div.append(s);
    ...
    var d = this, e = "filemanager", f = a.undef(d.fileManagerJson, d.basePath + "php/file_manager_json.php"),
        g = d.pluginsPath + e + "/images/", h = d.lang(e + ".");
    d.plugin.filemanagerDialog = function (b) {
        ...
        function m(b) {
            k(b, m);
            for (var d = b.file_list, e = 0, f = d.length; f > e; e++) {
                var i = d[e], l = a('<div class="ke-inline-block ke-item"></div>');
                v.append(l);
        ...
        var n = a.undef(b.width, 650), o = a.undef(b.height, 510), p = a.undef(b.dirName, ""),
            q = a.undef(b.viewType, "VIEW").toUpperCase(), r = b.clickFn,
            ...
            t = d.createDialog({name: e, width: n, height: o, title: d.lang(e), body: s}), u = t.div,
            v = a(".ke-plugin-filemanager-body", u), w = (a('[name="moveupImg"]', u), a('[name="moveupLink"]', u)),
            x = (a('[name="viewServer"]', u), a('[name="viewType"]', u)), y = a('[name="orderType"]', u), z = [];
        return x.val(q), i("", y.val(), "VIEW" == q ? m : l), t
    }
}), KindEditor.plugin("flash", function (a) {
    var b = this, c = "flash", d = b.lang(c + "."), e = a.undef(b.allowFlashUpload, !0),
        f = a.undef(b.allowFileManager, !1), g = a.undef(b.formatUploadUrl, !0),
        h = a.undef(b.extraFileUploadParams, {}), i = a.undef(b.filePostName, "imgFile"),
        ...
        edit: function () {
            var k = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + d.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + d.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + d.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + d.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /> ', "</div>", '<div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' + d.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /> ', "</div>", "</div>"].join(""),
                l = b.createDialog({
                    ...
                    yesBtn: {
                        name: b.lang("yes"), click: function () {
                            var c = a.trim(n.val()), d = p.val(), e = q.val();
                ...
                }), m = l.div, n = a('[name="url"]', m), o = a('[name="viewServer"]', m), p = a('[name="width"]', m),
                q = a('[name="height"]', m);
            if (n.val("http://"), e) {
            ...
            f ? o.click(function () {
                b.loadPlugin("filemanager", function () {
                    b.plugin.filemanagerDialog({
                        viewType: "LIST", dirName: "flash", clickFn: function (c) {
    ...
    var b = this, c = "image", d = a.undef(b.allowImageUpload, !0), e = a.undef(b.allowImageRemote, !0),
        f = a.undef(b.formatUploadUrl, !0), g = a.undef(b.allowFileManager, !1),
        h = a.undef(b.uploadJson, b.basePath + "php/upload_json.php"), i = a.undef(b.imageTabIndex, 0),
        j = b.pluginsPath + "image/images/", k = a.undef(b.extraFileUploadParams, {}),
        l = a.undef(b.filePostName, "imgFile"), m = a.undef(b.fillDescAfterUploadImage, !1), n = b.lang(c + ".");
    b.plugin.imageDialog = function (d) {
        ...
        var u,
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        if (!y.isLoading) {
                            ...
                            var c = a.trim(A.val()), d = D.val(), e = E.val(), f = G.val(), g = "";
            ...
            }), z = y.div, A = a('[name="url"]', z), B = a('[name="localUrl"]', z), C = a('[name="viewServer"]', z),
            D = a('.tab1 [name="width"]', z), E = a('.tab1 [name="height"]', z), F = a(".ke-refresh-btn", z),
            G = a('.tab1 [name="title"]', z), H = a('.tab1 [name="align"]', z);
        i && o ? (u = a.tabs({
            src: a(".tabs", z), afterSelect: function () {
            }
        }), u.add({title: n.remoteImage, panel: a(".tab1", z)}), u.add({
            title: n.localImage,
            panel: a(".tab2", z)
        ...
        I.fileBox.change(function () {
            ...
            b.loadPlugin("filemanager", function () {
                b.plugin.filemanagerDialog({
                    viewType: "VIEW", dirName: "image", clickFn: function (c) {
    ...
    var b = this, c = "insertfile", d = a.undef(b.allowFileUpload, !0), e = a.undef(b.allowFileManager, !1),
        f = a.undef(b.formatUploadUrl, !0), g = a.undef(b.uploadJson, b.basePath + "php/upload_json.php"),
        h = a.undef(b.extraFileUploadParams, {}), i = a.undef(b.filePostName, "imgFile"), j = b.lang(c + ".");
    b.plugin.fileDialog = function (k) {
        var l = a.undef(k.fileUrl, "http://"), m = a.undef(k.fileTitle, ""), n = k.clickFn,
        ...
        e ? s.click(function () {
            b.loadPlugin("filemanager", function () {
                b.plugin.filemanagerDialog({
                    viewType: "LIST", dirName: "file", clickFn: function (c) {
    ...
    var b = this, c = "lineheight", d = b.lang(c + ".");
    b.clickToolbar(c, function () {
        var e = "", f = b.cmd.commonNode({"*": ".line-height"});
        f && (e = f.css("line-height"));
        var g = b.createMenu({name: c, width: 150});
        a.each(d.lineHeight, function (c, d) {
            a.each(d, function (a, c) {
                g.addItem({
                    title: c, checked: e === a, click: function () {
                        b.cmd.toggle('<span style="line-height:' + a + ';"></span>', {span: ".line-height=" + a}), b.updateState(), b.addBookmark(), b.hideMenu()
                    }
                })
            })
        })
    ...
    b.plugin.link = {
        edit: function () {
            var d = b.lang(c + "."),
                ...
                }), g = f.div, h = a('input[name="url"]', g), i = a('select[name="type"]', g);
    ...
    var b = this, c = "media", d = b.lang(c + "."), e = a.undef(b.allowMediaUpload, !0),
        f = a.undef(b.allowFileManager, !1), g = a.undef(b.formatUploadUrl, !0),
        h = a.undef(b.extraFileUploadParams, {}), i = a.undef(b.filePostName, "imgFile"),
        j = a.undef(b.uploadJson, b.basePath + "php/upload_json.php");
    b.plugin.media = {
        edit: function () {
            var k = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + d.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + d.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + d.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + d.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' + d.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keAutostart">' + d.autostart + "</label>", '<input type="checkbox" id="keAutostart" name="autostart" value="" /> ', "</div>", "</div>"].join(""),
                ...
                q = a('[name="height"]', m), r = a('[name="autostart"]', m);
            if (n.val("http://"), e) {
            ...
            f ? o.click(function () {
                b.loadPlugin("filemanager", function () {
                    b.plugin.filemanagerDialog({
                        viewType: "LIST", dirName: "media", clickFn: function (c) {
                            b.dialogs.length > 1 && (a('[name="url"]', m).val(c), b.afterSelectFile && b.afterSelectFile.call(b, c), b.hideDialog())
                        }
                    })
                })
        ...
        init: function (b) {
            ...
            var e = {
                ...
                upload_start_handler: function (b) {
                    var c = this, d = a('div[data-id="' + b.id + '"]', c.bodyDiv);
                    a(".ke-status > div", d).hide(), a(".ke-progressbar", d).show()
                },
                upload_progress_handler: function (a, b, c) {
                    var e = Math.round(100 * b / c), f = d.progressbars[a.id];
                ...
                upload_success_handler: function (b, e) {
                    var f = a('div[data-id="' + b.id + '"]', d.bodyDiv).eq(0), g = {};
                    try {
                        g = a.json(e)
                    } catch (h) {
            ...
            return a(".ke-img", self.bodyDiv).each(function () {
                var c = a(this), d = c.attr("data-status");
            ...
            var c = this, d = a('<div class="ke-inline-block ke-item" data-id="' + b.id + '"></div>');
            c.bodyDiv.append(d);
    ...
    var b = this, c = "multiimage",
        d = (a.undef(b.formatUploadUrl, !0), a.undef(b.uploadJson, b.basePath + "php/upload_json.php")),
        e = b.pluginsPath + "multiimage/images/", f = a.undef(b.imageSizeLimit, "1MB"),
        g = (a.undef(b.imageFileTypes, "*.jpg;*.gif;*.png"), a.undef(b.imageUploadLimit, 20)),
        h = a.undef(b.filePostName, "imgFile"), i = b.lang(c + ".");
    b.plugin.multiImageDialog = function (j) {
        var k = j.clickFn, l = a.tmpl(i.uploadDesc, {uploadLimit: g, sizeLimit: f}),
            ...
            n = b.createDialog({
                ...
                body: m,
                previewBtn: {
                    name: i.insertAll, click: function () {
                        k.call(b, p.getUrlList())
                    }
                },
                yesBtn: {
                    name: i.clearAll, click: function () {
                        p.removeFiles()
                    }
                },
                beforeRemove: function () {
    ...
    window.SWFUpload = function (a) {
        ...
        if ("function" == typeof this.settings[a]) this.eventQueue.push(function () {
            ...
            c.executeNextEvent()
        }, 0); else if (null !== this.settings[a]) throw"Event handler " + a + " is unknown or is not a function"
        ...
        var b;
        if ("function" == typeof this.settings.upload_start_handler) a = this.unescapeFilePostParams(a), b = this.settings.upload_start_handler.call(this, a); else if (void 0 != this.settings.upload_start_handler) throw"upload_start_handler must be a function";
    ...
    b.clickToolbar(c, function () {
        var d = (b.lang(c + "."), '<div style="padding:10px 20px;"><iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe></div>'),
            e = b.createDialog({name: c, width: 750, title: b.lang(c), body: d}), f = a("iframe", e.div),
            g = a.iframeDoc(f);
    ...
    var c = this, d = "quickformat", e = a.toMap("blockquote,center,div,h1,h2,h3,h4,h5,h6,p");
    ...
    function c(c, d) {
        ...
        d.bind("click,mousedown", function (a) {
            ...
            f();
            var d = a(this), g = d.pos(), h = a.colorpicker({
                x: g.x,
                y: g.y + d.height(),
                z: 811214,
    ...
    var e = this, f = "table", g = e.lang(f + "."), h = "ke-zeroborder", i = [];
    e.plugin.table = {
        prop: function (d) {
            var i = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keRows" style="width:90px;">' + g.cells + "</label>", g.rows + ' <input type="text" id="keRows" class="ke-input-text ke-input-number" name="rows" value="" maxlength="4" /> &nbsp; ', g.cols + ' <input type="text" class="ke-input-text ke-input-number" name="cols" value="" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + g.size + "</label>", g.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + g.percent + "</option>", '<option value="px">' + g.px + "</option>", "</select> &nbsp; ", g.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + g.percent + "</option>", '<option value="px">' + g.px + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="kePadding" style="width:90px;">' + g.space + "</label>", g.padding + ' <input type="text" id="kePadding" class="ke-input-text ke-input-number" name="padding" value="" maxlength="4" /> &nbsp; ', g.spacing + ' <input type="text" class="ke-input-text ke-input-number" name="spacing" value="" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + g.align + "</label>", '<select id="keAlign" name="align">', '<option value="">' + g.alignDefault + "</option>", '<option value="left">' + g.alignLeft + "</option>", '<option value="center">' + g.alignCenter + "</option>", '<option value="right">' + g.alignRight + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + g.border + "</label>", g.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', g.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', "</div>", '<div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + g.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span>', "</div>", "</div>"].join(""),
                j = e.cmd.range.createBookmark(), k = e.createDialog({
                    name: f, width: 500, title: e.lang(f), body: i, beforeRemove: function () {
                        w.unbind()
                    }, yesBtn: {
                        name: e.lang("yes"), click: function () {
                            var b = m.val(), c = n.val(), d = o.val(), f = p.val(), g = q.val(), i = r.val(), k = s.val(),
                                l = t.val(), y = u.val(), z = v.val(), A = a(w[0]).html() || "", B = a(w[1]).html() || "";
                ...
                }), l = k.div, m = a('[name="rows"]', l).val(3), n = a('[name="cols"]', l).val(2),
                o = a('[name="width"]', l).val(100), p = a('[name="height"]', l), q = a('[name="widthType"]', l),
                r = a('[name="heightType"]', l), s = a('[name="padding"]', l).val(2),
                t = a('[name="spacing"]', l).val(0), u = a('[name="align"]', l), v = a('[name="border"]', l).val(1),
            ...
            if (!d && (x = e.plugin.getSelectedTable())) {
                ...
                var y, z = x[0].style.width || x[0].width, A = x[0].style.height || x[0].height;
            ...
            var d = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + g.size + "</label>", g.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + g.percent + "</option>", '<option value="px">' + g.px + "</option>", "</select> &nbsp; ", g.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + g.percent + "</option>", '<option value="px">' + g.px + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + g.align + "</label>", g.textAlign + ' <select id="keAlign" name="textAlign">', '<option value="">' + g.alignDefault + "</option>", '<option value="left">' + g.alignLeft + "</option>", '<option value="center">' + g.alignCenter + "</option>", '<option value="right">' + g.alignRight + "</option>", "</select> ", g.verticalAlign + ' <select name="verticalAlign">', '<option value="">' + g.alignDefault + "</option>", '<option value="top">' + g.alignTop + "</option>", '<option value="middle">' + g.alignMiddle + "</option>", '<option value="bottom">' + g.alignBottom + "</option>", '<option value="baseline">' + g.alignBaseline + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + g.border + "</label>", g.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', g.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', "</div>", '<div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + g.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span>', "</div>", "</div>"].join(""),
                h = e.cmd.range.createBookmark(), i = e.createDialog({
                    name: f,
                    width: 500,
                    ...
                    yesBtn: {
                        name: e.lang("yes"), click: function () {
                            var b = k.val(), c = l.val(), d = m.val(), f = n.val(), g = (o.val(), p.val(), q.val()),
                                i = r.val(), j = s.val(), u = a(t[0]).html() || "", w = a(t[1]).html() || "";
                ...
                }), j = i.div, k = a('[name="width"]', j).val(100), l = a('[name="height"]', j),
                m = a('[name="widthType"]', j), n = a('[name="heightType"]', j), o = a('[name="padding"]', j).val(2),
                p = a('[name="spacing"]', j).val(0), q = a('[name="textAlign"]', j), r = a('[name="verticalAlign"]', j),
                s = a('[name="border"]', j).val(1), t = a(".ke-input-color", j);
            c(j, t.eq(0)), c(j, t.eq(1)), b(t.eq(0), "#000000"), b(t.eq(1), ""), k[0].focus(), k[0].select();
            var u, v = e.plugin.getSelectedCell(), w = v[0].style.width || v[0].width || "",
            ...
            var c = e.plugin.getSelectedTable()[0], f = e.plugin.getSelectedRow()[0], g = e.plugin.getSelectedCell()[0],
                h = g.cellIndex + b;
            h += c.rows[0].cells.length - f.cells.length;
            for (var i = 0, j = c.rows.length; j > i; i++) {
                var k = c.rows[i], l = k.insertCell(h);
            ...
            var c = e.plugin.getSelectedTable()[0], d = e.plugin.getSelectedRow()[0], f = e.plugin.getSelectedCell()[0],
                g = d.rowIndex;
            ...
            var a = e.plugin.getSelectedTable()[0], b = e.plugin.getSelectedRow()[0], c = e.plugin.getSelectedCell()[0],
                d = b.rowIndex, f = d + c.rowSpan, g = a.rows[f];
            if (!(a.rows.length <= f)) {
                var h = c.cellIndex;
                if (!(g.cells.length <= h)) {
                    var i = g.cells[h];
            ...
            var a = (e.plugin.getSelectedTable()[0], e.plugin.getSelectedRow()[0]), b = e.plugin.getSelectedCell()[0],
                c = (a.rowIndex, b.cellIndex), d = c + 1;
            if (!(a.cells.length <= d)) {
                var f = a.cells[d];
            ...
            var b = e.plugin.getSelectedTable()[0], c = e.plugin.getSelectedRow()[0], f = e.plugin.getSelectedCell()[0],
                g = c.rowIndex;
            if (1 !== f.rowSpan) {
                for (var h = d(b, c, f), i = 1, j = f.rowSpan; j > i; i++) {
                    var k = b.rows[g + i], l = k.insertCell(h);
            ...
            var b = (e.plugin.getSelectedTable()[0], e.plugin.getSelectedRow()[0]), c = e.plugin.getSelectedCell()[0],
                d = c.cellIndex;
            if (1 !== c.colSpan) {
    ...
    var c = this, d = "template", e = (c.lang(d + "."), c.pluginsPath + d + "/html/");
    c.clickToolbar(d, function () {
        var e = c.lang(d + "."),
    ...
    b.clickToolbar(c, function () {
        var d = b.lang(c + "."),
            ...
            }), g = f.div, h = a("iframe", g), i = a.iframeDoc(h);
