          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                ...
                <#elseif type == 2>
                  <#if ylrc_organization.headPic??>
                    <#if ylrc_organization.headPic?length gt 0>
                        <img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${ylrc_organization.headPic}" alt="${ylrc_organization.name!""}" />
                    <#else>
                        <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_organization.name!""}" />
                    </#if>
                  <#else>
                        <img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_organization.name!""}" />
                  </#if>
                      <span>${ylrc_organization.name!""} <span class="caret"></span></span>
                </#if>
              </a>
