                ...
                <#include "../common/third-menu.ftl"/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th class="thead-th">头像</th>
                                            <th class="thead-th">用户名</th>
                                            <th class="thead-th">状态</th>
                                            <th class="thead-th">性别</th>
                                            <th class="thead-th">手机</th>
                                            <th class="thead-th">邮箱</th>
                                            <th class="thead-th">余额</th>
                      ...
                      <tr class="tbody-tr">
                          <td style="vertical-align:middle;">
                              <label class="lyear-checkbox checkbox-primary">
                                  <input type="checkbox" name="ids[]" value="${account.id}"><span></span>
                              </label>
                          </td>
                          <td style="vertical-align:middle;">
                        	<#if account.headPic??>
                          ...
                          <td style="vertical-align:middle;" align="center">${account.mobile}</td>
                          <td style="vertical-align:middle;" align="center">${account.email}</td>
                          <td style="vertical-align:middle;" align="center">${account.balance!"0"}</td>
                          <td style="vertical-align:middle;"><font class="text-success">${account.createTime}</font>
                          </td>
                      </tr>
                      </#list>
                      <#else>
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('前台用户删除成功!', function () {
