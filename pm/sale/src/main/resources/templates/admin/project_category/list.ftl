            ...
            <div class="container-fluid">
                ...
                <#include "../common/third-menu.ftl"/>
                      ...
                      <tr class="tbody-tr">
                          ...
                          <td style="vertical-align:middle;">
                        	${category.status.getValue()}
                          </td>
                          <td style="vertical-align:middle;"><font class="text-success">${category.createTime}</font>
                          </td>
                      </tr>
                      </#list>
                      <#else>
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('商品分类删除成功!', function () {
