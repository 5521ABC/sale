...
public class OrganizationService {
    ...
    {
        return organizationDao.findByMobile(phone);
    }
    ...
    public PageBean<Organization> findList(Organization entitiy, PageBean<Organization> pageBean)
    {
        ExampleMatcher exampleMatcher = ExampleMatcher
                ...
                .withIgnorePaths("balance", "auditStatus","sex");
     ...
     * @return
     */
    public int updatePassword(Organization organization){
        return organizationDao.updatePassword(organization);
    }
     ...
     * @return
     */
    public int updateRate(Organization organization){
        return organizationDao.updateRate(organization);
    }
}
