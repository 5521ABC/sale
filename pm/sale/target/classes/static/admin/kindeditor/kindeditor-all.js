...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img  class="kindimg"  src="' + _escape(url) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/index.ftl' : 'http://api.map.baidu.com/staticimage',
...
KindEditor.plugin('emoticons', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		function bindCellEvent(cell, j, num) {
			...
			cell.click(function(e) {
				self.insertHtml('<img src="' + path + num + '.gif" border="0" class="gif-photo" alt="" />').hideMenu().focus();
				e.stop();
			});
		}
