...
<div class="row lyear-wrapper">
    <div class="lyear-login">
        <div class="login-center" style="width: 29%;">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" >
            <div class="modal-header">
                ...
                <h4 class="modal-title">拍卖者忘记密码</h4>
            </div>
            <div class="modal-body">
                <div class="form-group has-feedback feedback-left">
                    <input type="text" placeholder="请输入您的邮箱" class="form-control required" name="email" id="email"
                           tips="请输入您的邮箱" />
                </div>
                <div class="form-group has-feedback feedback-left">
...
<script type="text/javascript">
    ...
    function updatePassword()
    {
        ...
        $.ajax({
            url:'/admin/organization/forget_password',
            type:'post',
            data:{
                password:password,
                email:email
